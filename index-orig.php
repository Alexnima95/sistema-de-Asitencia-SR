...
<div class="login-box">
  	...
  	<div class="login-box-body">
    	<h4 class="login-box-msg">Ingresa tu ID de Colaborador</h4>
          ...
          <div class="form-group">
           <p>Seleccione Estado:</p>
            <select class="form-control" name="status">
      		...
      		<div class="row">
    			<div class="form-group">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" name="signin"><i class="fa fa-sign-in"></i>Registrar acceso</button>
        		</div>
      		</div>
      		<div class="date">
